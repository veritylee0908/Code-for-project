...
# * overall error
#
# nriver = 1     # choice of river
# nratingc = 0   # when there is a rating curve: value is 1; when flow data are given value is 0
...
#
if nriver == 1: # River Eden Sheepmount 05-12-2015 to 08-12-2015 ; (nriver,nractingc,nriverflag)=(1 0 0)
    Data = pd.read_csv('River_Eden_Sheepmount_Shortened_2015-12-05_to_2015-12-08.csv') # Suboptimal: not the source file from EA but editted file; needs to be source file
   
    ht = 7.2 # Threshold (subject to change)
    error = 0.035  # upper bounds chosen from error at gauging station
    stitle = 'River Eden at Sheepmount 2015'
...
# Establish flow/discharge data either from "Data" file
if nratingc == 1: # not the case for this river as =0 so ignore this section
    w = []
...
plt.title("River Eden at Sheepmount 2015 Square Lake Plot", size = 30)
