...
# -------------------------------------------------
# INPUTS
# Replace the FEV values below with your final section 5 values
# if they differ from these placeholders.
# -------------------------------------------------
depth = 2.0

# Use the benchmark/event FEVs from your section 5 analysis
FEV_2005 = 9.34   # example / placeholder
FEV_2015 = 9.34   # example / placeholder
